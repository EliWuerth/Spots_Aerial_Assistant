...
def mainInterface():
    ...
    side_layout_title = QLabel("Settings", alignment=Qt.AlignCenter)
    side_layout_title.setStyleSheet("font-size: 18px; color: black; font-weight: bold;")
    side_layout.addWidget(side_layout_title)
    ...
    speed_slider.setFixedWidth(175)
    ...
    angular_label = QLabel("Spin Speed: 0.8 rad/s")
    ...
    angular_slider.setFixedWidth(175)
    ...
    bg_label = ResizableBackground("./Image/Gold-Brayer2.png")
    ...
    toggle_menu_button.setStyleSheet("background-color: black; color: white; font-size: 20px;")
...
class RobotControlApp(QMainWindow):
    def __init__(self):
        ...
        bg_label = ResizableBackground("./Image/Gold-Brayer.png")
...
class RegisterDialog(QDialog):
    def __init__(self, conn, cursor, parent=None):
        ...
        # --- Background Image ---
        bg_label = ResizableBackground("./Image/bg6.jpg")
